...
public class MultiHttpSecurityConfig  {
    ...
    public UserDetailsService adminUserDetailsService(){
        //获取登录用户信息
        return username -> {
        	Account admin = sysLoginAccountMapper.selectAccountByUserName(username);
//        	Account admin = new Account(1L,"admin","$2a$10$uR.U4ve6OspI9oWF215gnupVlHjfMMVfvXFSBl1MuP7IFkjfdWeza","admin");
            if (admin != null){
                //获取权限  x:x:x权限集合
